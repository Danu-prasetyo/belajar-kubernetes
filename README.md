...
✅ **Deployment**
	- Deployment bisa mengtaur replicaset secara otomatis jika kita melakukan update atau rollback versi aplikasi
	- By default deployment akan menggunaka metode rolling update agar aplikasi tidak mengalami downtime
	- daripada harus menghapus replicaset dan menjalankan kembali, lebih baik pake deployment untuk mengabstraksi replicaset

- Ilustrasi
	- deployment akan membuat pod dengan versi ter-update
	- ![[Pasted image 20250525005151.png]]
	- ketika pod dengan versi ter-update berhasil dibuat, maka pod versi yang lama akan dibuang
	- ![[Pasted image 20250525005419.png]]
	- ![[Pasted image 20250525005952.png]]


✅**SERVICE**

![[Pasted image 20250526093543.png]]
...
- **ClusterIP**
- ![[Pasted image 20250526093833.png]]
...
-  ![[Pasted image 20250526094251.png]]
...
- **NodePort**
- ![[Pasted image 20250526143829.png]]
- ![[Pasted image 20250526143807.png]]
...
- ![[Pasted image 20250527104700.png]]
...
- **INGRESS**
- ![[Pasted image 20250527111235.png]]
- ![[Pasted image 20250527111259.png]]
...
✅**DaemonSet**
- ![[Pasted image 20250528113354.png]]
...
✅**Cron jobs**
- ![[Pasted image 20250528114924.png]]
...
- ![[Pasted image 20250528155448.png]]
- jika sudah satu menit, maka status activenya akan berubah
  ![[Pasted image 20250528155534.png]]
...
- ![[Pasted image 20250528155751.png]]
- kita juga bisa mengecek logs-nya menggunakan perintah `kubectl logs -f <nama_pod>`
- ![[Pasted image 20250528155852.png]]


✅**Environtment Variable**
![[Pasted image 20250528160240.png]]
...
✅**Secret**
- ![[Pasted image 20250528160944.png]]
- **COMMAND**
	- membuat secret
```
...
![[Pasted image 20250609144157.png]]
...
```
	kubectl get pod
```
![[Pasted image 20250609145115.png]]
- cek environtment yang ada didalam pod
```
	kubectl exec -it <pod_name> -- env
```
![[Pasted image 20250609145200.png]]

✅**Secret: Mount File**
![[Pasted image 20250610092956.png]]
...
✅**ConfigMaps**
![[Pasted image 20250610154153.png]]
...
✅**Autoscaler**
	...
	![[Pasted image 20250612092513.png]]
...
- Horizontal Pod Autoscaler
	...
	![[Pasted image 20250612092600.png]]

	![[Pasted image 20250612092623.png]]
...
- Cek List Pod (Sebelum HPA ditrigger)
	...
	kubectl get pod
	```
	![[Pasted image 20250612104037.png]]
- Cek apakah HPA berhasil dibuat
	```
	kubectl get hpa
	```
	![[Pasted image 20250612104107.png]]
...
- Trigger HPA
	- Menggunakan port forward untuk mengexpose servicenya
		- cek service yang berjalan
			...
			kubectl get service
			```
			![[Pasted image 20250612110053.png]]
		- port forward
			```
			kubectl  port-forward svc/nama_service port:port
			```
			![[Pasted image 20250612110230.png]]
...
- Cek Beban kerja pod
	![[Pasted image 20250612112410.png]]
